...
## Application on CRC organoid dataset from Gao lab
We have applied this method to a single cell dataset from KRAS-mutant colon cancer patient-derived organoids evolved under the pressure of dual inhibitors. 
